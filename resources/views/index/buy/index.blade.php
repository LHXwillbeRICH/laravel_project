...
<div class="app app-touch ">
    <div id="wrapper" class="mg001">
        <div data-v-8b47c92c="">
            <div data-v-8b47c92c="" class="top-header border-bottom fixed-top header-bgsell"><!----> <h2 data-v-8b47c92c="" class="f36">我要买</h2>
                <div data-v-8b47c92c="" class="top-right"><a data-v-8b47c92c="" class="fl history"></a></div></div>
        </div>
      ...
      <a href="{{url('Index/gameSearch')}}" class="search-navs">
        ...
        <button type="submit" class="iconfont icon-sousuos"></button>
                ...
                <div data-v-ab70c204="" class="tab">
                    <div data-v-ab70c204="" class="tab-head">
                        <ul data-v-ab70c204="" class="tab-nav">
                            <li data-v-ab70c204="" @if($type == 1) class="active" @endif ><a href="{{url('/Buy/index')}}"  data-v-ab70c204="">手游</a></li>
                            <li data-v-ab70c204="" @if($type == 2) class="active" @endif >
                                <a href="{{url('/Buy/index',['type'=>2])}} class="dn router-link-active" data-v-ab70c204="">H5游戏</a>
                            </li>
                        </ul>
                    </div>
                                        ...
                                        <div data-v-3d7cbfe2="" infinite-scroll-disabled="loading" infinite-scroll-immediate-check="test" infinite-scroll-distance="600">
                                            <ul data-v-ab70c204="" data-v-3d7cbfe2="" style="background-color: white;">
                                                ...
                                                <li data-v-ab70c204="" data-v-3d7cbfe2="">
                                                    <a href="{{url('/Buy/store_list',['id'=>$info['id']])}}" class="" data-v-ab70c204="" data-v-3d7cbfe2="">
                                                        <center data-v-ab70c204="">
                                                        <img data-v-ab70c204="" src="{{asset('storage')}}/{{$info['game_logo']}}" class="null loaded">
                                                        </center>
                                                        <p data-v-ab70c204="">{{$info['game_name']}}</p>
                                                    </a>
                                                </li>
                                                @endforeach
            ...
            <div data-v-71ff2779="" data-v-ab70c204=""><a data-v-71ff2779="" id="BackToTop" style="display: none;"></a></div>
...
<!-- <script src="https://m.5173.com/js/jweixin-1.2.0.js"></script> -->
...
<script type="text/javascript">NTKF_PARAM = {siteid: "bq_1000",settingid: "bq_1000_1472795888825",uid: "",uname: "",isvip: "0",userlevel: "1",erpparam: "abc"}</script><script type="text/javascript" src="{{asset('js')}}/sell/ntkfstat.js" charset="utf-8"></script></body></html>